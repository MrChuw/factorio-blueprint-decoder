...
def eh_loader(stream, index, entity):
    ...
    if version >= V_1_1_75_1:
        # Old blueprints have 0.0f, redefined blueprints 1.0f.
        stream.ignore(4, "(in loader)")
    if version >= V_1_1_77_2:
        stream.expect(0x00, 0x00)
    if version >= V_1_1_83_4:
        stream.expect(0x00, 0x00)

    stream.expect(*[0x00]*4)
    # default: 5 empty filters
    ep_filters(stream, index, entity)
